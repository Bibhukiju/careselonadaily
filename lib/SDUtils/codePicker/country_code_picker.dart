import 'package:CarsellonaDaily/SDUtils/AppConstant.dart';
import 'package:CarsellonaDaily/SDUtils/SDStyle.dart';
import 'package:CarsellonaDaily/SDUtils/codePicker/selection_dialog.dart';
  ...
  State<StatefulWidget> createState() {
    ...
    List<QIBusCountryCode> elements = jsonList
        .map((s) => QIBusCountryCode(
              ...
              flagUri: 'https://www.countryflags.io/${s['code'].toLowerCase()}/flat/64.png',
            ))
        .toList();
